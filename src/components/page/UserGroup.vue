  ...
  <div>
    ...
    <div class="container">
      ...
      <el-table :data="tableData" stripe style="width: 100%;margin-top:10px">
        <el-table-column type="index" width="120" :index="indexMethod"></el-table-column>
        <el-table-column prop="groupName" label="用户组" width="120"></el-table-column>
        <el-table-column prop="pagePermission" label="页面权限" width="400"></el-table-column>
        <el-table-column prop="groupPermission" label="权限名"></el-table-column>
      ...
      <el-dialog title="编辑分组" :visible.sync="centerDialogVisible" width="30%" style="height:1000px">
        <el-form :model="form">
      ...
      <el-dialog title="新增分组" :visible.sync="DialogVisible" width="40%" style="height:1000px">
